...
test('drag from column chooser to header panel: when columnChooser.sortOrder is defined', async (t) => {
...
test('drag from column chooser to header panel: when columnChooser searchPanel has value', async (t) => {
  const expectedColumns = [0, 1, 3];
